...
const PROTECTED_TENANT_LIST_ENDPOINT_PATH = '/tenants/{tenantId}/orgs/0/properties';
...
export function buildProtectedTenantConfigListUrl(tenantId) {
  return buildProtectedTenantConfigUrl(tenantId, PROTECTED_TENANT_LIST_ENDPOINT_PATH);
}
...
export async function fetchProtectedTenantConfigList(options) {
  return fetchProtectedTenantConfig(options, PROTECTED_TENANT_LIST_ENDPOINT_PATH);
}
